...
|----------------------------------------------|----------------------|---------------------|---------------|------------|
|**Solvents **                                 |**Specifications **   |**3ARP321002 **      |**3ARP321003 **|**3ARP321004|
|                                              |                      |                     |               |**          |
|----------------------------------------------|----------------------|---------------------|---------------|------------|
|Acetonitrile _[LOD:15 ppm; LOQ: 52 ppm] _     |Not more than 200 ppm |Below Detection Limit                |Below       |
|                                              |                      |                                     |quantitation|
|                                              |                      |                                     |limit       |
|----------------------------------------------|----------------------|---------------------|---------------|------------|
|Isopropyl alcohol _[LOD:30 ppm; LOQ: 75 ppm] _|Not more than 2000 ppm|116 ppm              |141 ppm        |140 ppm     |
|----------------------------------------------|----------------------|---------------------|---------------|------------|
|Cyclohexane _[LOD:1 ppm; LOQ: 4 ppm] _        |Not more than 1000 ppm|Below Detection Limit                             |
--------------------------------------------------------------------------------------------------------------------------"""
    ),
    (
        "table15",
...
|**3 **                    |3ARP321004|0.03%                    |
|--------------------------|----------|-------------------------|
|**_Specification Limit _**           |**_Not more than 0.1% _**|
-----------------------------------------------------------------"""
    ),
    (
        "table16",
        ...
        0,
        """---------------------------------------------------------------------------------------------------------------------------
|Element     |Class     |Detection Limit         |Quantitation Limit         |Batch #                                     |
|------------|----------|------------------------|---------------------------|---------------|---------------|------------|
|**Element **|**Class **|**Detection** **Limit **|**Quantitation** **Limit **|**3ARP317001 **|**3ARP317002 **|**3ARP318001|
|            |          |                        |                           |               |               |**          |
|------------|----------|------------------------|---------------------------|---------------|---------------|------------|
...
|Element     |Class         |Detection Limit         |Quantitation Limit         |Batch #                                     |
|------------|--------------|------------------------|---------------------------|----------------|-------------|-------------|
|**Element **|**Class **    |**Detection** **Limit **|**Quantitation** **Limit **|**3APR3/12001 **|**3APR3/12002|**3APR3/12003|
|            |              |                        |                           |                |**           |**           |
|------------|--------------|------------------------|---------------------------|----------------|-------------|-------------|
|**Al **     |Other elements|2.2 ppm                 |6.5 ppm                    |BDL             |BDL          |BDL          |
-------------------------------------------------------------------------------------------------------------------------------"""
    ),
    (
        "table18",
