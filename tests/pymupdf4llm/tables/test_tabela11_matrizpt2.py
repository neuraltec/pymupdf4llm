...
sys.path.insert(0, "/home/aluno/NeuralTec(2)/NeuralTec/pymupdf4llm/pymupdf4llm")
...
def extrair_primeira_tabela_llm(pdf_path: Path, strategy="lines_strict", pagina=21):
    """
...
def extrair_primeira_tabela_pymupdf(pdf_path: Path, strategy="lines_strict", pagina=21):
    """
...
def test_primeira_tabela_com_llm(pdf_teste):
    ...
    for strategy in estrategias:
        tabela, estrutura_completa = extrair_primeira_tabela_llm(pdf_teste, strategy, pagina=21)
    ...
    if tabela is None:
        print("\npymupdf4llm não encontrou tabelas na página 21, tentando PyMuPDF diretamente...")
        for strategy in estrategias:
            tabela, estrutura_completa = extrair_primeira_tabela_pymupdf(pdf_teste, strategy, pagina=21)
            if tabela is not None:
                estrategia_usada = strategy
    ...
    esperado = {
                (0, 0): "Source",
                (0, 1): "Are there any direct source of nitrosamines (Like sodium nitrites and amines) (Yes/No)",
                (0, 2): "Remarks",
                (1, 0): "Solvents used in key starting materials and drug substance manufacturing",
                (1, 1): "No",
                (1, 2): "Risk of formation of nitroso impurities due to solvents is eliminated.",
                (2, 0): "Reagents used in key starting materials and drug substance manufacturing",
                (2, 1): "No",
                (2, 2): "Risk of formation of nitroso impurities due to reagents is eliminated. There is a possibility for carryover of secondary amines (DBA) & Tetra Butyl Ammonium Iodide (TBAI). Since, there is no source of nitrite used during the manufacturing process of drug substance, risk of formation of nitrosamine impurities due to secondary amines from DBA and TBAI is ruled out.",
                (3, 0): "All the possible process and degradation impurities in key starting materials and drug substance",
                (3, 1): "No",
                (3, 2): "Risk of formation of nitroso impurities due to the possible process and degradation impurities in key starting materials and drug substance is eliminated.",
                (4, 0): "Recovered solvents used",
                (4, 1): "No",
                (4, 2): "Risk of formation of nitroso impurities due to use of recovered solvents is eliminated as recovered solvents are not used in the manufacturing process of Aripiprazole.",
                (5, 0): "Is there a risk of nitrosamines forming in the API synthetic process taking into consideration the combination of reagents, solvents, catalysts and starting materials used, intermediates formed, impurities and degradants",
                (5, 1): "No",
                (5, 2): "Risk of formation of nitroso impurities due combination of reagents, solvents, catalysts and starting materials used, intermediates formed, impurities and degradants is eliminated.",
            }
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| Source                                                                                                         | Are there any direct source of nitrosamines| Remarks                                                                                              |
|                                                                                                                |(Like sodium nitrites and amines) (Yes/No)  |                                                                                                      |                                                                                                           |
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| Solvents used in key starting materials and drug substance manufacturing                                       | No                                         | Risk of formation of nitroso impurities due to solvents is eliminated.                               |                                                                                                               |
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| Reagents used in key starting materials and drug substance manufacturing                                       | No                                         | Risk of formation of nitroso impurities due to reagents is eliminated.                               |
|                                                                                                                |                                            |  There is a possibility for carryover of secondary amines (DBA) & Tetra Butyl Ammonium Iodide (TBAI).|
|                                                                                                                |                                            | Since, there is no source of nitrite used during the manufacturing process of                        |
|                                                                                                                |                                            | drug substance, risk of formation of nitrosamine impurities due to secondary amines                  |   
|                                                                                                                |                                            |  from DBA and TBAI is ruled out.                                                                     |   
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| All the possible process and degradation impurities in key starting materials and drug substance               | No                                         | Risk of formation of nitroso impurities due to the possible process and                              |   
|                                                                                                                |                                            |  degradation impurities in key starting materials and drug substance is eliminated.                  |        
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| Recovered solvents used                                                                                        | No                                         | Risk of formation of nitroso impurities due to use of recovered solvents is eliminated               |
|                                                                                                                |                                              as recovered solvents are not used in the manufacturing process of Aripiprazole.                     |
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| Is there a risk of nitrosamines forming in the API synthetic process taking into consideration the combination | No                                         | Risk of formation of nitroso impurities due combination of reagents, solvents, catalysts and         |                                                                                                                                                          starting materials used, intermediates formed, impurities and degradants is eliminated.              |
| of reagents, solvents, catalysts and starting materials used, intermediates formed, impurities and degradants  |                                            |                                                                                                      |                                                                                                                                                                    |
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    """
...
"""
    ...
    for strategy in estrategias:
        ...
        # Busca especificamente na página 21 
        idx_pagina = 21 - 1
        if idx_pagina < len(chunks):
            ch = chunks[idx_pagina]
            tabelas = ch.get("tables") or []
